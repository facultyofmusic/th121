...
public final class CL10 {
	...
	public static int clSetKernelArg(CLKernel kernel, int arg_index, ByteBuffer arg_value) {
		...
		int __result = nclSetKernelArg(kernel.getPointer(), arg_index, (arg_value == null ? 0 : arg_value.remaining()), arg_value, arg_value != null ? arg_value.position() : 0, function_pointer);
		return __result;
	}
	public static int clSetKernelArg(CLKernel kernel, int arg_index, DoubleBuffer arg_value) {
		...
		if (arg_value != null)
			BufferChecks.checkDirect(arg_value);
		int __result = nclSetKernelArg(kernel.getPointer(), arg_index, ((arg_value == null ? 0 : arg_value.remaining()) << 3), arg_value, arg_value != null ? arg_value.position() << 3 : 0, function_pointer);
		return __result;
	}
	public static int clSetKernelArg(CLKernel kernel, int arg_index, FloatBuffer arg_value) {
		...
		if (arg_value != null)
			BufferChecks.checkDirect(arg_value);
		int __result = nclSetKernelArg(kernel.getPointer(), arg_index, ((arg_value == null ? 0 : arg_value.remaining()) << 2), arg_value, arg_value != null ? arg_value.position() << 2 : 0, function_pointer);
		return __result;
	}
	...
	public static int clSetKernelArg(CLKernel kernel, int arg_index, ShortBuffer arg_value) {
		...
		if (arg_value != null)
			BufferChecks.checkDirect(arg_value);
		int __result = nclSetKernelArg(kernel.getPointer(), arg_index, ((arg_value == null ? 0 : arg_value.remaining()) << 1), arg_value, arg_value != null ? arg_value.position() << 1 : 0, function_pointer);
		return __result;
	}
	...
	static int clSetKernelArg(CLKernel kernel, int arg_index, long arg_size, Buffer arg_value) {
		long function_pointer = CLCapabilities.clSetKernelArg;
		BufferChecks.checkFunctionAddress(function_pointer);
		BufferChecks.checkBufferSize(arg_value, 1);
		int __result = nclSetKernelArg(kernel.getPointer(), arg_index, arg_size, arg_value, arg_value.position(), function_pointer);
		return __result;
	}
